...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Marqué la opcion 1 o 2 o 3");
        ...
        switch (opcion) {
            ...
            case MAXOFARRAY: {
                ...
                p = new Max3Prob(disorderedArr);
                dc = new Max3DivDC();
                ArrayList<Integer> maxArr = ((Max3Sol) dc.solve(p)).getMax3();
                s = new Max3Sol(maxArr);
                System.out.println(s);
                break;
            }
            default:
